...
const messages = [
  { name: "John Doe", message: "Hey! How's it going?", time: "3:45 PM", avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxtYWxlJTIwcG9ydHJhaXR8ZW58MHx8fHwxNzEyNTQyNzQyfDA&ixlib=rb-4.0.3&q=80&w=1080" },
  { name: "Jane Smith", message: "Did you finish the project?", time: "1:32 PM", avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxmZW1hbGUlMjBwb3J0cmFpdHxlbnwwfHx8fDE3MTI1NDI3NDN8MA&ixlib=rb-4.0.3&q=80&w=1080" },
